...
card)
        For example
                % ifconfig gani0
RTL8169/8111 chipset dosn't support 1Gbpis half duplex mode.
...
4. Testing
  Testing before installation is strongly recommended.
	...
	# init 6                      (for solaris10 or later, reboot here)
        # modload obj/gani
