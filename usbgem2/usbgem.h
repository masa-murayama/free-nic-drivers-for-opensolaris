...
#pragma	ident	"@(#)usbgem.h	1.4 16/10/10"
...
#define	MAC_STATE_POWERUP	1	/* powered up but not initialized */
#define	MAC_STATE_STOPPED	2	/* stopped */
#define	MAC_STATE_INITIALIZED	3	/* initialized */
#define	MAC_STATE_ONLINE	4	/* working correctly  */
#define	MAC_STATE_ERROR		5	/* need to restart nic */
