h24599
s 00006/00006/00275
d D 1.6 09/02/12 01:20:45 mrym 6 5
c volatile added
e
s 00007/00003/00274
d D 1.5 06/12/29 10:29:47 mrym 5 4
c 2.4.0
e
s 00008/00008/00269
d D 1.4 05/05/09 21:57:33 mrym 4 3
c 0.8.10
e
s 00019/00015/00258
d D 1.3 05/01/11 00:17:54 mrym 3 2
c tx list and rx list fixed to access uint32 only
e
s 00010/00010/00263
d D 1.2 04/05/09 10:15:41 mrym 2 1
c 0.8.5
e
s 00273/00000/00000
d D 1.1 03/12/06 11:43:52 mrym 1 0
c date and time created 03/12/06 11:43:52 by mrym
e
u
U
f e 0
...
D 3
	volatile uint16_t	rx_cstat;
	volatile uint16_t	framesize;
E 3
I 3
	volatile uint32_t	rx_cstat;
E 3
	volatile struct frag	frags[TNE_MAXRXFRAGS];
E 4
I 4
D 6
	uint32_t	forward_ptr;
...
D 3
/* Bit definition on Rx CSTAT */
#define	RC_FrmCmp	0x4000	/* Frame complete */
#define	RC_RxEOC	0x0800	/*  */
#define	RC_RxError	0x0400	/* Error frame */
#define	RC_DPpr		0x0010	/* Demand priority frame priority */
#define	RC_MBO		0x3000	/* Must be one for backword compatibility */
E 3
I 3
...
D 3
#define	TC_FrmCmp	0x4000	/* Frame complete */
#define	TC_TxEOC	0x0800	/*  */
#define	TC_PassCRC	0x0200	/* use last data as CRC */
#define	TC_NetPri	0x0007	/* Demand priority frame priority */
#define	TC_MBO		0x3000	/* Must be one for backword compatibility */
E 3
I 3
