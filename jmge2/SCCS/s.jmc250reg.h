h39136
s 00046/00005/00765
d D 1.4 12/04/04 20:20:31 mrym 4 3
c 2.6.4
e
s 00005/00002/00765
d D 1.3 11/10/23 23:44:10 mrym 3 2
c 2.6.3
e
s 00061/00014/00706
d D 1.2 11/02/06 16:46:50 mrym 2 1
c 2.6.2
e
s 00720/00000/00000
d D 1.1 08/12/15 23:37:53 mrym 1 0
c date and time created 08/12/15 23:37:53 by mrym
e
u
U
f e 0
...
D 4
#define	GIGAR0	0x400	/* 6: */
#define	GIGARA	0x408	/* 6: */
#define	GIGARB	0x410	/* 6: */
#define	GIGARC	0x418	/* 6: */
#define	GIGARD	0x420	/* 6: */
E 4
I 4
...
D 2
#define GHC_TO_CLK	0x00C00000U
#define		GHC_TO_CLK_SHIFT	22
#define		GHC_TO_CLK_OFF		(0U << GHC_TO_CLK_SHIFT)
#define		GHC_TO_CLK_GPHY		(1U << GHC_TO_CLK_SHIFT)
#define		GHC_TO_CLK_PCIE		(2U << GHC_TO_CLK_SHIFT)
#define		GHC_TO_CLK_INVALID	(3U << GHC_TO_CLK_SHIFT)
#define GHC_TXMAC	0x00300000
#define		GHC_TXMAC_SHIFT	20
#define		GHC_TXMAC_CLK_OFF	(0U << GHC_TXMAC_SHIFT)
#define		GHC_TXMAC_CLK_GPHY	(1U << GHC_TXMAC_SHIFT)
#define		GHC_TXMAC_CLK_PCIE	(2U << GHC_TXMAC_SHIFT)
#define		GHC_TXMAC_CLK_INVALID	(3U << GHC_TXMAC_SHIFT)
E 2
I 2
...
D 3
#define		GHC_TXCKSRC_GPHY_RX	(1U << GHC_TXCKSRC_SHIFT)
#define		GHC_TXCKSRC_GPHY_TX	(2U << GHC_TXCKSRC_SHIFT)
E 3
I 3
