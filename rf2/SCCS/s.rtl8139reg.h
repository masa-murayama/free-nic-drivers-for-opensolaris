h64667
s 00002/00001/00327
d D 1.7 03/10/23 07:36:13 mrym 7 6
c 8139 rev k added
e
s 00009/00003/00319
d D 1.6 03/02/01 10:53:08 mrym 6 5
c 0.9.5 release
e
s 00008/00008/00314
d D 1.5 03/01/05 20:46:02 mrym 5 4
c TCR_MXDMA_XXX fixed
e
s 00002/00002/00320
d D 1.4 03/01/05 16:14:35 mrym 4 3
c declaration of public domain.
e
s 00014/00009/00308
d D 1.3 02/08/01 22:19:59 mrym 3 2
c 0.8.3 for 8139D and 810x
e
s 00013/00004/00304
d D 1.2 02/07/21 20:16:10 mrym 2 1
c 0.8.2 8129 support
e
s 00308/00000/00000
d D 1.1 02/06/09 00:35:56 mrym 1 0
c date and time created 02/06/09 00:35:56 by mrym
e
u
U
f e 0
 ...
 * %W% %E%
D 2
 * Macro definitions based on Realtek RTL8139C data sheet
E 2
I 2
D 4
...
D 2
#define	CONFIG4	0x005a	/* Configuration register 4 */
E 2
I 2
#define	CONFIG4	0x005a	/* Configuration register 4 (8139 only) */
D 3
#define MDIO    0x005a	/* MII interface (8129 only) */
E 3
I 3
...
E 3
D 6
#define	CONFIG6	0x00d8	/* Configuration register 5 */
E 6
I 6
...
D 3
#define	TCR_HWREV	0x7c800000	/* Hardware revision ID */		
E 3
I 3
#define	TCR_HWREV		0x7cc00000 /* Hardware revision ID */		
E 3
D 7
#define		HWREV_8139	0x60000000	
E 7
I 7
...
D 5
#define	TCR_MXDMA_16		0
#define	TCR_MXDMA_32		1
#define	TCR_MXDMA_64		2
#define	TCR_MXDMA_128		3
#define	TCR_MXDMA_256		4
#define	TCR_MXDMA_512		5
...
D 2
/* Configration register 4 (0x5a, uint8_t) */
E 2
I 2
...
I 2
D 3
/* MII interface (0x5a, uint8_t) 8129 only */
#define MDIO_DIR        0x80
#define MDIO_DOUT       0x04
#define MDIO_DOUT_SHIFT 2
#define MDIO_DIN        0x02
#define MDIO_DIN_SHIFT  1
