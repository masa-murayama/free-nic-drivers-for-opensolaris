h43658
s 00006/00006/00430
d D 1.4 09/02/11 23:49:02 mrym 4 3
c 2.6.1
e
s 00020/00009/00416
d D 1.3 05/08/28 08:57:18 mrym 3 2
c 0.8.0
e
s 00127/00029/00298
d D 1.2 05/05/02 22:39:51 mrym 2 1
c volatile removed
e
s 00327/00000/00000
d D 1.1 03/09/13 23:17:05 mrym 1 0
c date and time created 03/09/13 23:17:05 by mrym
e
u
U
f e 0
...
/* COMMAND register */
D 2
#define	CMD_TXUGO	0x80
#define	CMD_STOP_RDMA	0x40	/* Stop receive side  dma */
#define	CMD_STOP_TDMA	0x20	/* Stop transmit side dma */
#define	CMD_NEXTFRAME	0x10	/* receive next packet */
#define	CMD_RXQUEUED	0x08
#define	CMD_TXQUEUED	0x04
#define	CMD_START_RX	0x02	/* start receiver */
#define	CMD_STOP_RX	0x01	/* stop receiver */
E 2
I 2
...
D 2
#define	INT_PTA		0x08000000	/* PCI target abort */
#define	INT_PMA		0x04000000	/* PCI master abort */
#define	INT_APE		0x02000000	/* PCI address parity error */
#define	INT_DPE		0x01000000	/* PCI data parity error */
E 2
I 2
...
D 2
#define	INT_PME		0x00004000	/* power management event */
#define	INT_FATAL_INT	0x00001000	/* fatal error (27:24) occured */
#define	INT_RCT		0x00000800	/* receive copy threshold crossed */
E 2
I 2
...
D 2
#define	PBLCNT_MASK	0x3f
#define	CRCCNT_MASK	0xff
#define	ALICNT_MASK	0xff
#define	MPCNT_MASK	0xff
E 2
I 2
#define	GENCTL_BITS	\
	"\020"	\
...
D 3
#define	NVCTL_IPG_DLY	0x00000780
#define		NVCTL_IPG_DLY_SHIFT	7
#define	NVCTL_CBMODE	0x00000040
...
D 2
#define	MIICFG_ALTCLK	0x0040
#define	MIICFG_ENSMI	0x0020
E 2
I 2
...
D 2
#define	MIICFG_ENSM	0x0001	/* 1: 10M, 0:IEEE MII */
E 2
I 2
