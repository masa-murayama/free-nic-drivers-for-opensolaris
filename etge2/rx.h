...
struct fbr_desc {
	uint32_t	rxfd0;	/* low address */
	uint32_t	rxfd1;	/* high address */
	uint32_t	rxfd2;
#define	RXFD2_BI	0x000003ffU
};
...
struct rx_sdesc {
	uint32_t	rxsd0;
#define	RXSD0_ASW_LONG_EVT	0x80000000U	/* Rx long event */
#define	RXSD0_ASW_VLAN_TAG	0x40000000U	/* VLAN tag detected */
#define	RXSD0_ASW_UNSUPPORTED_OP	0x20000000U	/* unsupported OP code */
#define	RXSD0_ASW_PAUSE_FRAME	0x10000000U	/* is a pause frame */
#define	RXSD0_ASW_CONTROL_FRAME	0x08000000U	/* is a control frame */
#define	RXSD0_ASW_DRIBBLE_NIBBLE	0x04000000U	/* spurious bits after EOP */
#define	RXSD0_ASW_BROADCAST	0x02000000U	/* has a broadcast address */
#define	RXSD0_ASW_MULTICAST	0x01000000U	/* has a multicast address */
#define	RXSD0_ASW_OK	0x00800000U	/* valid CRC + no code error */
#define	RXSD0_ASW_TOO_LONG	0x00400000U	/* frame length > 1518 bytes */
#define	RXSD0_ASW_LEN_CHK_ERR	0x00200000U	/* frame length field incorrect */
#define	RXSD0_ASW_CRC_ERR	0x00100000U	/* CRC error */
#define	RXSD0_ASW_CODE_ERR	0x00080000U	/* one or more nibbles signalled as errors */
#define	RXSD0_ASW_FALSE_CARRIER_EVENT	0x00040000U	/* bad carrier since last good packet */
#define	RXSD0_ASW_RX_DV_EVENT	0x00020000U	/* short receive event detected */
#define	RXSD0_ASW_PREV_PKT_DROPPED	0x00010000U	/* IFG too small on previous */
#define	RXSD0_VP	0x00000400U	/* VLAN Packet */
#define	RXSD0_JP	0x00000200U	/* Jumbo Packet */
#define	RXSD0_FT	0x00000100U	/* Frame Truncated */
#define	RXSD0_DROP	0x00000080U	/* Drop packet */
#define	RXSD0_RXMAC_ERROR	0x00000040U	/* RXMAC Error Indicator */
#define	RXSD0_WOL	0x00000020U	/* WOL Event */
#define	RXSD0_TCPP	0x00000010U	/* TCP checksum pass */
#define	RXSD0_TCPA	0x00000008U	/* TCP checksum assist */
#define	RXSD0_IPP	0x00000004U	/* IP checksum pass */
#define	RXSD0_IPA	0x00000002U	/* IP checksum assist */
#define	RXSD0_HP	0x00000001U	/* hash pass */

	uint32_t	rxsd1;
#define	RXSD1_RI	0x0c000000U	/* Ring Index */
#define		RXSD1_RI_SHIFT	26	/* Ring Index */
#define	RXSD1_BI	0x03ff0000U	/* Buffer Index */
#define		RXSD1_BI_SHIFT	16
#define	RXSD1_LENGTH	0x0000ffffU	/* length in bytes */
}
/*===========================================================================*/
