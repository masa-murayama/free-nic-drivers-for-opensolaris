...
1. Introduction
  ...
  This is the AXIS ax88172 usb2.0 to fast ethernet driver for Solaris.
...
Tested OS version
 Solaris10 x86 with usbddk 0.9
 As axf driver requires new usb framework in solaris, it doesn't work under
...
A. This massage may appear when the link partner does not have auto
   ...
   axfN-duplex=["full"|"half"] axfN-speed=[100|10]; # where N is a unit number

  For example
	axf0-duplex="full" axf0-speed=100;   # full-duplex 100Mbps for axf0
	axf0-duplex="half" axf0-speed=10;    # half-duplex 10Mbps for axf0
