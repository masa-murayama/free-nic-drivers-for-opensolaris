...
#define	DESCBASE_HI	0x18	/* L: */
#define	DATABUFBASE_HI	0x1c	/* L: */
...
#define	RCR_PROM	0x10U	/* promiscous, accept all physical packets */
...
#define	RCR_SEP		0x01U	/* accept CRC error packets */
...
#define	TCR_TB2BDIS	0x80U	/* rsvd */
#define	TCR_COLTMC	0x0cU	/* collision retry count */
#define		TCR_COLTMC_MASK	0x3
#define		TCR_COLTMC_SHIFT	2
#define		TCR_COLTMC_16	(0U <<  TCR_COLTMC_SHIFT)
#define		TCR_COLTMC_32	(1U <<  TCR_COLTMC_SHIFT)
#define		TCR_COLTMC_48	(2U <<  TCR_COLTMC_SHIFT)
#define		TCR_COLTMC_FOREVER	(3U <<  TCR_COLTMC_SHIFT)
#define	TCR_LB		0x03U
...
#define	CR_INTPCTL	0x04000000U	/* enable interrupt pending control */
#define	CR_GINTMSK1	0x02000000U	/* disable INT#A */
#define	CR_SWPEND	0x01000000U	/* disable multi-level INT#A */
...
#define	CR_SFRST	0x00008000U	/* software reset */
#define	CR_TM1EN	0x00004000U	/* enable timer1 (periodic) */
#define	CR_TM0EN	0x00002000U	/* enable timer0 (one shot) */
...
#define	DCFG_XMWI	0x8000U	/* rsvd */
#define	DCFG_XMRM	0x4000U	/* rsvd */
#define	DCFG_XMRL	0x2000U	/* disable memory read line */
#define	DCFG_PERDIS	0x1000U	/* disable parity error detection */
#define	DCFG_MRM	0x0800U	/* replace MRL with MRM */
...
/* MCFG (offset 0x7e) MAC tx/rx configuration register  */
#define	MCFG_TXARB	0x8000U
#define	MCFG_TXQBK	0x0c00U
#define		MCFG_TXQBK_SHIFT	10
