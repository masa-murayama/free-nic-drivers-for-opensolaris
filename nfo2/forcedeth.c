...
#define NVREG_MSI_VECTOR_0_ENABLED 0x01
	NvRegMisc1 = 0x080,
#define NVREG_MISC1_PAUSE_TX	0x01			/* XXX */
#define NVREG_MISC1_HD		0x02
#define NVREG_MISC1_FORCE	0x3b0f3c

	NvRegMacReset = 0x3c,		/* XXX */
#define NVREG_MAC_RESET_ASSERT	0x0F3
	NvRegTransmitterControl = 0x084,
#define NVREG_XMITCTL_START	0x01
#define NVREG_XMITCTL_MGMT_ST	0x40000000		/* XXX */
#define NVREG_XMITCTL_SYNC_MASK		0x000f0000	/* XXX */
#define NVREG_XMITCTL_SYNC_NOT_READY	0x0		/* XXX */
#define NVREG_XMITCTL_SYNC_PHY_INIT	0x00040000	/* XXX */
#define NVREG_XMITCTL_MGMT_SEMA_MASK	0x00000f00	/* XXX */
#define NVREG_XMITCTL_MGMT_SEMA_FREE	0x0		/* XXX */
#define NVREG_XMITCTL_HOST_SEMA_MASK	0x0000f000	/* XXX */
#define NVREG_XMITCTL_HOST_SEMA_ACQ	0x0000f000	/* XXX */
#define NVREG_XMITCTL_HOST_LOADED	0x00004000	/* XXX */
#define NVREG_XMITCTL_TX_PATH_EN	0x01000000	/* XXX */
	NvRegTransmitterStatus = 0x088,
#define NVREG_XMITSTAT_BUSY	0x01

	NvRegPacketFilterFlags = 0x8c,
#define NVREG_PFF_PAUSE_RX	0x08		/* XXX */
...
#define NVREG_RCVCTL_RX_PATH_EN	0x01000000	/* XXX */
...
#define NVREG_TX_WM_DESC1_DEFAULT	0x0200010		/* XXX */
#define NVREG_TX_WM_DESC2_3_DEFAULT	0x1e08000		/* XXX */
#define NVREG_TX_WM_DESC2_3_1000	0xfe08000		/* XXX */
...
#define NVREG_TXRXCTL_DESC_3	0xc02200			/* XXX */
#define NVREG_TXRXCTL_VLANSTRIP 0x00040
#define NVREG_TXRXCTL_VLANINS	0x00080
	NvRegTxRingPhysAddrHigh = 0x148,
	NvRegRxRingPhysAddrHigh = 0x14C,
	NvRegTxPauseFrame = 0x170,
#define NVREG_TX_PAUSEFRAME_DISABLE	0x1ff0080		/* XXX */
...
#define NVREG_MIISTAT_MASK2		0x000f
	NvRegMIIMask = 0x184,						/* XXX */
#define NVREG_MII_LINKCHANGE		0x0008

	NvRegAdapterControl = 0x188,				/* XXX */
...
/* XXXX */
static int phy_init(struct net_device *dev)	/* called once on attach */
{
	struct fe_priv *np = get_nvpriv(dev);
	u8 __iomem *base = get_hwbase(dev);
	...
	if (np->phy_model == PHY_MODEL_MARVELL_E3016) {	/* XXX */
...
/* MII_NCONFIG is 0x1c */
		...
		phy_reserved |= PHY_CICADA_INIT5; /* XXX */
...
static void nv_mac_reset(struct net_device *dev)
{
	...
	writel(NVREG_MAC_RESET_ASSERT, base + NvRegMacReset);	/* XXX */
	pci_push(base);
	udelay(NV_MAC_RESET_DELAY);

	writel(0, base + NvRegMacReset);	/* XXX */
	pci_push(base);
	udelay(NV_MAC_RESET_DELAY);
			...
			if (likely(Flags & NV_RX2_DESCRIPTORVALID)) {
				...
				if (unlikely(Flags & NV_RX2_ERROR)) {
					...
					/* framing errors are soft errors */
						...
						if (Flags & NV_RX2_SUBSTRACT1) {	/* XXX */
							len--;
						}
					}
					/* the rest are hard errors */
...
static int __devinit nv_probe(struct pci_dev *pci_dev, const struct pci_device_id *id)
{
	...
	if (txreg & NVREG_TRANSMITPOLL_MAC_ADDR_REV) {		/* XXX */
	...
	if (id->driver_data & DEV_HAS_POWER_CNTRL) {		/* XXX */
		u8 revision_id;
	...
	writel(0, base + NvRegMIIMask);				/* XXX */
