h48219
s 00043/00030/00661
d D 1.3 11/09/19 23:19:07 mrym 3 2
c 2.6.0
e
s 00008/00008/00683
d D 1.2 06/07/12 23:52:40 mrym 2 1
c 
e
s 00691/00000/00000
d D 1.1 06/07/11 21:38:45 mrym 1 0
c date and time created 06/07/11 21:38:45 by mrym
e
u
U
f e 0
...
/* Window 1 */
D 2
#define	W1RxError		0x4	/* obsolute, 90X only */
#define	W1RxStatus		0x8	/* obsolute, 90X only */
#define	W1Timer			0xa	/* obsolute, 90X only */
#define	W1TxStatus		0xb	/* obsolute, 90X only */
#define	W1TxFree		0xc	/* obsolute, 90X only */
E 2
I 2
...
D 2
#define	W3ResetOptions_old	0x8	/* w, obsolute, 90x */
E 2
I 2
...
D 2
#define	W7Timer			0xa	/* B, obsolute, 90X only */
#define	W7TxStatus		0xb	/* B, obsolute, 90X only */
E 2
I 2
...
D 3
#define	IC_ramSize		0x00000007	/* 90x */
E 3
I 3
...
D 3
#define		IC_ramSize8KB		(0 << ramSizeShift)
#define		IC_ramSize32KB		(2 << ramSizeShift)
#define		IC_ramSize64KB		(3 << ramSizeShift)
#define		IC_ramSize128KB		(4 << ramSizeShift)
E 3
I 3
...
D 3
#define		IC_romSize8KB_A		(0 << romSizeShift)
#define		IC_romSize16KB_A	(1 << romSizeShift)
#define		IC_romSize32KB_A	(2 << romSizeShift)
#define		IC_romSize64KB_A	(3 << romSizeShift)
#define		IC_romSize64KB_B	(0 << romSizeShift)
#define		IC_romSize128KB_B	(1 << romSizeShift)
#define	IC_disableBadSsdDetect	0x00000100
#define	IC_ramLocation		0x00000200
#define	IC_enableTxLarge	0x00004000
#define	IC_ramPartition		0x00030000
E 3
I 3
...
D 3
#define		IC_ramPartition53		(0 << ramPartitionShift)
#define		IC_ramPartition31		(1 << ramPartitionShift)
#define		IC_ramPartition11		(2 << ramPartitionShift)
#define		IC_ramPartition35		(3 << ramPartitionShift)
E 3
I 3
...
D 3
#define	IC_xcvrSelect		0x00f00000
E 3
I 3
...
D 3
#define		xcvrSelect10BASET	0
#define		xcvrSelectAUI		1
#define		xcvrSelect10BASE2	3
#define		xcvrSelect100BASETX	4
#define		xcvrSelect100BASEFX	5
#define		xcvrSelectMII		6
#define		xcvrSelectAN		8	/* 10baseT */
#define		xcvrSelectMIIExt	9
#define	IC_autoSelect		0x01000000
#define	IC_disableBiosROM	0x02000000
E 3
I 3
