h36618
s 00008/00008/00639
d D 1.8 08/07/04 22:31:42 mrym 8 7
c 2.6.1
e
s 00008/00008/00639
d D 1.7 05/04/23 01:13:15 mrym 7 6
c 0.9.38
e
s 00004/00001/00643
d D 1.6 03/11/05 21:33:46 mrym 6 5
c 0.9.27
e
s 00057/00041/00587
d D 1.5 03/11/03 07:05:04 mrym 5 4
c 0.9.25
e
s 00080/00000/00548
d D 1.4 03/08/02 20:31:05 mrym 4 3
c liteon LC82C168 support
e
s 00001/00000/00547
d D 1.3 03/04/14 23:36:08 mrym 3 2
c public domain declaration added
e
s 00047/00006/00500
d D 1.2 02/12/29 02:13:26 mrym 2 1
c for tu 0.9.1
e
s 00506/00000/00000
d D 1.1 02/12/22 20:54:08 mrym 1 0
c date and time created 02/12/22 20:54:08 by mrym
e
u
U
f e 0
...
D 5
#define	SIASTAT	0x60	/* SIA status register */
E 5
I 5
...
D 5
#define	SIACNTL	0x70	/* SIA tx and rx control register */
...
D 6
/* CSR12 (offset=0x60) SIASTAT - SIA Status Register */
E 6
I 6
...
/* CSR14 (offset=0x70) */
D 2
#define	SIACNTL_PAUSE	0x00080000	/* Advertise Pause (mx) */
E 2
I 2
D 5
#define	SIACNTL_PAUSE	0x00080000	/* Advertise Pause */
E 2
#define	SIACNTL_T4	0x00040000	/* Advertise 100Base-T4 */
#define	SIACNTL_TXF	0x00020000	/* Advertise 100Base-TX full duplex */
#define	SIACNTL_TXH	0x00010000	/* Advertise 100Base-TX half duplex */
#define	SIACNTL_TAS	0x00008000	/* Monitor 10Base-T and AUI (21) */
D 2
#define	SIACNTL_SPP	0x00004000	/* Set Polarity for 10base */
E 2
I 2
#define	SIACNTL_SPP	0x00004000	/* Set Polarity Plus for 10base */
E 2
#define	SIACNTL_APE	0x00002000	/* Auto Polarity enable */
#define	SIACNTL_LTE	0x00001000	/* Link test ebnable */
#define	SIACNTL_SQE	0x00000800	/* Signal Quality (Heart beat) enable */
#define	SIACNTL_CLD	0x00000400	/* Collision Detect Enable */
#define	SIACNTL_CSQ	0x00000200	/* Collision Squelch Enable */
#define	SIACNTL_RSQ	0x00000100	/* Receive Squelch Enable */
#define	SIACNTL_ANE	0x00000080	/* Autonegotiation Enable */
#define	SIACNTL_TH	0x00000040	/* Advertise 10Base-T Half duplex */
#define	SIACNTL_CPEN	0x00000030	/* 10Base-T compensation enable */
#define	SIACNTL_LSE	0x00000008	/* Link pulse send enable */
D 2
#define	SIACNTL_DREN	0x00000004	/* Driver Enable (21) */
#define	SIACNTL_LBK	0x00000002	/* Loopback Enable (21)*/
#define	SIACNTL_PWD10B	0x00000002	/* Loopback Enable (mx)*/
#define	SIACNTL_ECEN	0x00000001	/* Encoder Enable (21) */
E 2
I 2
#define	SIACNTL_DREN	0x00000004	/* Driver Enable */
#define	SIACNTL_LBK	0x00000002	/* Loopback Enable */
#define	SIACNTL_ECEN	0x00000001	/* Encoder Enable */
E 5
I 5
...
I 2
D 5
#define	SIACNTL_10BASET_HALF	\
	( SIACNTL_SPP | SIACNTL_APE | SIACNTL_LTE	\
	| SIACNTL_SQE | SIACNTL_CLD | SIACNTL_CSQ	\
	| SIACNTL_RSQ | SIACNTL_CPEN| SIACNTL_LSE	\
	| SIACNTL_DREN| SIACNTL_LBK | SIACNTL_ECEN)
E 5
I 5
